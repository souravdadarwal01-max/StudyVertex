    ...
    <main className="min-h-screen bg-gray-100 py-20 px-6">
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-lg p-10">
        ...
        <p className="mt-6 text-lg text-gray-600">
          ...
          Get professional academic assistance from expert tutors.
          StudyVertex provides personalized support for assignments,
          homework, projects, research work and academic learning.
